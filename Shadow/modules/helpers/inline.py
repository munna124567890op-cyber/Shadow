...
DEV_OP = [
    [
        InlineKeyboardButton(
            text="✫ ᴀᴅᴅ ᴍᴇ ʙᴀʙʏ ✫",
            url=f"https://t.me/{Shadow.username}?startgroup=true",
        ),
    ],
    [
...
HELP_BUTN = [
    [
        InlineKeyboardButton(
            text="✫ ʜᴇʟᴘ ✫", url=f"https://t.me/{Shadow.username}?start=help"
        ),
        InlineKeyboardButton(text="✫ ᴄʟᴏsᴇ ✫", callback_data="CLOSE"),
    ],
]
...
ABOUT_BTN = [
    ...
    [
        InlineKeyboardButton(text="♕︎ ᴏᴡɴᴇʀ ♕︎", user_id=OWNER),
     #   InlineKeyboardButton(text="✫ sᴏᴜʀᴄᴇ ✫", callback_data="SOURCE"),
    ],
    [
