...
from Shadow.database.chats import add_served_chat
from Shadow.database.users import add_served_user
from Shadow.modules.helpers import (
    CLOSE_BTN,
    DEV_OP,
    HELP_BTN,
    HELP_BUTN,
...
async def start(_, m: Message):
    if m.chat.type == ChatType.PRIVATE:
        ...
        await accha.edit("Ꭻᴀʏ Sʜʀᴇᴇ")
        await asyncio.sleep(0.2)
        await accha.edit("ᎫᴀʏㅤᏚʜʀᴇᴇ")
        await asyncio.sleep(0.2)
        await accha.edit("🙏|| Rᴀᴅʜᴇʏ Kʀɪsʜɴᴀ ||🙏")
        await asyncio.sleep(0.2)
        await accha.delete()
        ...
        await m.reply_photo(
            ...
            caption=f"""**♲︎︎︎ ɪɴɴᴏᴠᴀᴛɪᴠᴇ ᴀɪ ᴅᴇᴠᴇʟᴏᴘᴇʀ ♲︎︎︎**
            
**ᴇxᴘᴇʀɪᴇɴᴄᴇ ᴛʜᴇ ғᴜᴛᴜʀᴇ ᴏғ ᴄʜᴀᴛʙᴏᴛs ᴡɪᴛʜ

[{Shadow.name}](t.me/{Shadow.username})!**
...
<b>💞 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/i_t_z_broken'>ʟᴏᴠᴇ 💞</a></b>""",
...
@Shadow.on_cmd("help")
async def help(client: Shadow, m: Message):
    if m.chat.type == ChatType.PRIVATE:
...
@Shadow.on_message(filters.new_chat_members)
