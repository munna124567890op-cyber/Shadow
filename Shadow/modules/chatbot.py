...
from Shadow.modules.helpers import CHATBOT_ON, is_admins


@Shadow.on_cmd("chatbot", group_only=True)
...
async def chatbot_text(client: Client, message: Message):
    ...
    if not message.reply_to_message:
        JAANdb = MongoClient(MONGO_URL)
        JAAN = JAANdb["JAANDb"]["JAAN"]
        is_JAAN = JAAN.find_one({"chat_id": message.chat.id})
        if not is_JAAN:
